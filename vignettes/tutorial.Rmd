...
There are other function in the package to abundant the analysis. CI gives confidence interval of estimates in the model. Proper confidence level and variables can be selected. The speed of CI function is slightly slower than confint().
